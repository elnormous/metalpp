...
namespace mtl
{
    ...
    public:
        ...
        {
            const id name = sendMessage<id>(*this, sel::name);
            return ns::String{sendMessage<id>(name, ns::sel::retain)};
        }

        [[nodiscard]] CommandQueue newCommandQueue() const noexcept
        {
            const id commandQueue = sendMessage<id>(*this, sel::newCommandQueue);
        ...
        {
            const id commandQueue = sendMessage<id>(*this,
        ...
        {
            const id depthStencilState = sendMessage<id>(*this,
        ...
        {
            const id buffer = sendMessage<id>(*this,
        ...
        {
            const id texture = sendMessage<id>(*this,
        ...
        {
            const id library = sendMessage<id>(*this, sel::newDefaultLibrary);
        ...
        {
            id error;
            const id library = sendMessage<id>(*this,
        ...
        {
            id error;
            const id renderPipelineState = sendMessage<id>(*this,
    ...
    {
        const id device = sendMessage<id>(*this, sel::device);
